...
bool Compute(PID_t *pid)
{
   ...
   if(timeChange>=pid->SampleTime)
   {
      ...
      if(!pOnE) pid->outputSum-= pid->kp * dInput;
 ...
 ******************************************************************************/
double GetKp(PID_t *pid){ return  pid->dispKp; }
double GetKi(PID_t *pid){ return  pid->dispKi;}
double GetKd(PID_t *pid){ return  pid->dispKd;}
int GetMode(PID_t *pid){ return  inAuto ? AUTOMATIC : MANUAL;}
int GetDirection(PID_t *pid){ return pid->controllerDirection;}
